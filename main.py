...
def main():
    ...
    # get positions for players and ball in tracks
    ...
    for frame_num, player_track in enumerate(tracks['players']):
        ...
        if assigned_player != -1:
            ...
            team_ball_control.append(team_ball_control[-1]) # if ball is not assigned to any player in current frame, assume ball control is same as previous frame 
    ...
    # draw output - camera movement
    output_video_frames = camera_movement_estimator.draw_camera_movement(output_video_frames, camera_movement_per_frame)
    # draw output - speed and distance

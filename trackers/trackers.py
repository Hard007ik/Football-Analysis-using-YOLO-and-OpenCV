...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        tracks={
            "players":[], # [ frame 1- {0:{"bbox":[x1,y1,x2,y2]}, 1:{"bbox":[x1,y1,x2,y2]}}, frame 2 -{0:{"bbox":[x1,y1,x2,y2]}, 1:{"bbox":[x1,y1,x2,y2]}}, ...]
            "referees":[],
            "ball":[]
        }
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        # draw transparent rectangle at bottom right corner
        overlay = frame.copy() # help to make the rectangle transparent
